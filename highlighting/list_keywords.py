...
LEVELS = {
    ...
    11: {
        "space_before_and_after": ["is", "at", "add", "to_list", "remove", "from", "in", "not_in", "if", "for", "range", "to", "repeat", "color", "define", "call"],
        "no_space": ["comma", "-", "=", "/", "\\*", "\\+"],
        "space_before": ["print", "sleep", "forward", "turn", "random", "else", "times"],
        "space_after": [],
        "constant": ["black", "blue", "brown", "gray", "green", "orange", "pink", "purple", "red", "white", "yellow"],
    ...
    12: {
        "space_before_and_after": ["is", "at", "add", "to_list", "remove", "from", "in", "not_in", "if", "for", "range", "to", "repeat", "color", "define", "call", "with", "using"],
        "no_space": ["comma", "-", "=", "/", "\\*", "\\+"],
        "space_before": ["print", "sleep", "forward", "turn", "random", "else", "times"],
        "space_after": [],
        "constant": ["black", "blue", "brown", "gray", "green", "orange", "pink", "purple", "red", "white", "yellow"],
    ...
    13: {
        "space_before_and_after": ["is", "at", "add", "to_list", "remove", "from", "in", "not_in", "if", "for", "range", "to", "and", "or", "repeat", "color", "define", "call", "with", "using"],
        "no_space": ["comma", "-", "=", "/", "\\*", "\\+"],
        "space_before": ["print", "sleep", "forward", "turn", "random", "else", "times"],
        "space_after": [],
        "constant": ["black", "blue", "brown", "gray", "green", "orange", "pink", "purple", "red", "white", "yellow"],
    ...
    14: {
        "space_before_and_after": ["is", "at", "add", "to_list", "remove", "from", "in", "not_in", "if", "for", "range", "to", "and", "or", "else", "repeat", "color", "define", "call", "with", "using", "return"],
        "no_space": ["comma", "-", "=", "/", "\\*", "\\+", "<", ">", "!"],
    ...
    15: {
        "space_before_and_after": ["is", "at", "add", "to_list", "remove", "from", "in", "not_in", "if", "for", "range", "to", "and", "or", "while", "repeat", "color", "define", "call", "with", "using", "return"],
        "no_space": ["comma", "-", "=", "/", "\\*", "\\+", "<", ">", "!"],
        "space_before": ["print", "sleep", "forward", "turn", "random", "else", "times"],
        "space_after": [],
        "constant": ["black", "blue", "brown", "gray", "green", "orange", "pink", "purple", "red", "white", "yellow"],
    ...
    16: {
        "space_before_and_after": ["is", "at", "add", "to_list", "remove", "from", "in", "not_in", "if", "else", "for", "range", "to", "and", "or", "while", "repeat", "color", "define", "call", "with", "using", "return"],
        "no_space": ["comma", "-", "=", "/", "\\*", "\\+", "<", ">", "!", "\\[", "\\]"],
        "space_before": ["print", "sleep", "forward", "turn", "random", "times"],
        "space_after": [],
        "constant": ["black", "blue", "brown", "gray", "green", "orange", "pink", "purple", "red", "white", "yellow"],
    ...
    18: {
        "space_before_and_after": ["is", "at", "add", "to_list", "remove", "from", "in", "not_in", "if", "else", "for", "range", "to", "and", "or", "while", "input", "repeat", "color", "def", "return"],
        "no_space": ["comma", "-", "=", "/", "\\*", "\\+", "<", ">", "!", "\\[", "\\]", ":", "\\(", "\\)"],
        "space_before": ["print", "sleep", "forward", "turn", "random", "times"],
        "space_after": ["elif"],
        "constant": ["black", "blue", "brown", "gray", "green", "orange", "pink", "purple", "red", "white", "yellow"],
