...
KEYWORDS = {
    ...
    11 :{
        "SP_K_SP" : ["is","at","add","to_list","remove","from","in","if","for","range","to"],
        "K"       : [",","-","=","/","\\*","\\+"],
    ...
    13 :{
        "SP_K_SP" : ["is","at","add","to_list","remove","from","in","if","for","range","to","and","or"],
        "K"       : [",","-","=","/","\\*","\\+"],
        "SP_K"    : ["print","ask","sleep","random","else"],
        "K_SP"    : [],
    },
    14 :{
        "SP_K_SP" : ["is","at","add","to_list","remove","from","in","if","for","range","to","and","or","else"],
        "K"       : [",","-","=","/","\\*","\\+","<",">","!"],
        "SP_K"    : ["print","ask","sleep","random"],
        "K_SP"    : [],
    },
    15 :{
        "SP_K_SP" : ["is","at","add","to_list","remove","from","in","if","for","range","to","and","or","while"],
        "K"       : [",","-","=","/","\\*","\\+","<",">","!"],
        "SP_K"    : ["print","ask","sleep","random","else"],
        "K_SP"    : [],
    },
    16 :{
        "SP_K_SP" : ["is","at","add","to_list","remove","from","in","if","else","for","range","to","and","or","while"],
        "K"       : [",","-","=","/","\\*","\\+","<",">","!","\\[","\\]"],
        "SP_K"    : ["print","ask","sleep","random"],
        "K_SP"    : [],
    },
    ...
    18 :{
        "SP_K_SP" : ["is","at","add","to_list","remove","from","in","if","else","for","range","to","and","or","while","input"],
        "K"       : [",","-","=","/","\\*","\\+","<",">","!","\\[","\\]",":","\\(","\\)"],
