...
def auth_templates (page, lang, menu):
    if page == 'signup':
        return render_template ('signup.html', lang=lang, menu=menu)
    if page == 'login':
        return render_template ('login.html', lang=lang, menu=menu)
    if page == 'my-profile':
        return render_template ('profile.html', lang=lang, menu=menu)
