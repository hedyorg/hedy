...
class UndefinedVarException(HedyException):
    def __init__(self, name, line_number):
        super().__init__("Var Undefined", name=name, line_number=line_number)


class CyclicVariableDefinitionException(HedyException):
    def __init__(self, variable, line_number):
        super().__init__(
            "Cyclic Var Definition", variable=variable, line_number=line_number
        )


class InvalidArgumentTypeException(HedyException):
    def __init__(
        self, command, invalid_type, allowed_types, invalid_argument, line_number
    ):
        super().__init__(
...
class InvalidAtCommandException(HedyException):
    def __init__(self, command, level, line_number):
        super().__init__(
            "Invalid At Command", command=command, level=level, line_number=line_number
        )
...
class IncompleteRepeatException(HedyException):
    def __init__(self, command, level, line_number):
        super().__init__(
            "Incomplete Repeat", command=command, level=level, line_number=line_number
        )


class LonelyTextException(HedyException):
    def __init__(self, level, line_number):
        super().__init__("Lonely Text", level=level, line_number=line_number)
