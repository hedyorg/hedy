...
describe("General tests for my programs page (with both custom teacher and built-in adventure)", () => {
    ...
    describe('Test filters', () => {
        ...
        it("The level filter should show the appropiate programs", ()=>{        
            ...
            cy.getDataCy('program_3e8926c0515d47a5aeb116164b1278c9').should('be.visible')
            cy.getDataCy('program_195d94e733ff49b08079848409e664b6').should('be.visible')

            cy.getDataCy('program_e1d94726655947c5b0309abb18cc17ca').should('not.exist')
            cy.getDataCy('program_4c426ff4cd5a40d7bb65bfbb35907f8b').should('not.exist')
    
            // After selecting level 1 only the programs from level 1 should ve visible
            cy.getDataCy('levels_dropdown').select('1')
    
            cy.getDataCy('program_3e8926c0515d47a5aeb116164b1278c9').should('not.exist')
            cy.getDataCy('program_195d94e733ff49b08079848409e664b6').should('not.exist')
    
            cy.getDataCy('program_e1d94726655947c5b0309abb18cc17ca').should('be.visible')
            cy.getDataCy('program_4c426ff4cd5a40d7bb65bfbb35907f8b').should('be.visible')
