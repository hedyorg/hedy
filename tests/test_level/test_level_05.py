...
class TestsLevel5(HedyTester):
    ...
    def test_if_equality_unquoted_rhs_with_space_and_trailing_space_linebreak_print(
        self,
    ):
        code = textwrap.dedent(
            """\
    ...
    def test_if_not_in_list_print(self):
        ...
        self.multi_level_tester(
            max_level=7, code=code, expected=expected, output="found"
        )
    ...
    def test_if_not_in_list_in_print(self):
        ...
        self.multi_level_tester(
            max_level=7, code=code, expected=expected, output="not found!"
        )
    ...
    def test_if_in_undefined_list(self):
        ...
        self.multi_level_tester(
            code=code, exception=hedy.exceptions.UndefinedVarException, max_level=7
        )
    ...
    def test_if_equality_unquoted_rhs_with_space_print_gives_error(self):
        ...
        skipped_mappings = [
            SkippedMapping(
                SourceRange(2, 1, 2, 37), hedy.exceptions.UnquotedEqualityCheck
            ),
        ]

        self.multi_level_tester(
            code=code, expected=expected, skipped_mappings=skipped_mappings, max_level=7
        )

    def test_if_equality_unquoted_rhs_with_space_and_following_command_print_gives_error(
        self,
    ):
        code = textwrap.dedent(
            """\
        ...
        skipped_mappings = [
            SkippedMapping(
                SourceRange(2, 1, 2, 59), hedy.exceptions.UnquotedEqualityCheck
            ),
        ]
    ...
    def test_if_equality_unquoted_rhs_with_space_assign_gives_error(self):
        ...
        skipped_mappings = [
            SkippedMapping(
                SourceRange(2, 1, 2, 43), hedy.exceptions.UnquotedEqualityCheck
            ),
        ]
    ...
    def test_if_equality_quoted_rhs_with_space(self, q):
        ...
        self.single_level_tester(
            code=code, expected_commands=["is", "if", "print"], expected=expected
        )
    ...
    def test_if_equality_text_with_spaces_and_single_quotes_linebreak_print_else_print(
        self,
    ):
        code = textwrap.dedent(
            """\
    ...
    def test_if_equality_text_with_spaces_and_double_quotes_linebreak_print_else_print(
        self,
    ):
        code = textwrap.dedent(
            """\
    ...
    def test_if_indent_gives_parse_error(self):
        ...
        skipped_mappings = [
            ...
            SkippedMapping(
                SourceRange(3, 1, 3, 23), hedy.exceptions.InvalidSpaceException
            ),
        ]
    ...
    def test_line_with_if_with_space_gives_invalid(self):
        ...
        skipped_mappings = [
            SkippedMapping(
                SourceRange(2, 1, 2, 45), hedy.exceptions.InvalidSpaceException
            ),
        ]
    ...
    def test_pront_should_suggest_print(self):
        ...
        skipped_mappings = [
            SkippedMapping(
                SourceRange(1, 1, 1, 23), hedy.exceptions.InvalidCommandException
            ),
        ]
        ...
        self.multi_level_tester(
            ...
            extra_check_function=lambda c: str(c.arguments["guessed_command"])
            == "print",
        )
    ...
    def test_print_no_quotes(self):
        ...
        skipped_mappings = [
            SkippedMapping(
                SourceRange(1, 1, 1, 37), hedy.exceptions.UnquotedTextException
            ),
        ]
    ...
    def test_print_quote_gives_exception(self):
        ...
        skipped_mappings = [
            SkippedMapping(
                SourceRange(1, 1, 1, 27), hedy.exceptions.UnquotedTextException
            ),
        ]
    ...
    def test_if_equality_print_backtick_text_gives_error(self):
        ...
        skipped_mappings = [
            SkippedMapping(
                SourceRange(1, 11, 1, 23), hedy.exceptions.UnquotedTextException
            ),
            SkippedMapping(
                SourceRange(1, 29, 1, 40), hedy.exceptions.UnquotedTextException
            ),
        ]

        self.multi_level_tester(
            max_level=5, code=code, expected=expected, skipped_mappings=skipped_mappings
        )
    ...
    def test_if_fix_nl(self):
        ...
        self.multi_level_tester(
            max_level=5, code=code, lang="nl", expected=expected, translate=False
        )
    ...
    def test_if_pressed_missing_else_gives_error(self):
        ...
        skipped_mappings = [
            SkippedMapping(
                SourceRange(1, 1, 1, 28), hedy.exceptions.MissingElseForPressitException
            ),
        ]

        self.multi_level_tester(
            max_level=7, code=code, expected=expected, skipped_mappings=skipped_mappings
        )
