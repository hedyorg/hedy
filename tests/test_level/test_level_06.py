...
class TestsLevel6(HedyTester):
    ...
    def test_sleep_with_calc(self):
        ...
        expected = HedyTester.dedent(
            "n = int(1) * int(2) + int(3)", HedyTester.sleep_command_transpiled("n")
        )
    ...
    def test_if_2_vars_equality_print(self):
        ...
        self.multi_level_tester(
            max_level=7, code=code, expected=expected, output="gelijkspel!"
        )
    ...
    def test_equality_arabic(self):
        ...
        self.multi_level_tester(
            max_level=7, code=code, expected=expected, output="jahoor!"
        )
    ...
    def test_if_with_negative_number(self):
      ...
      if convert_numerals('Latin', antwoord) == convert_numerals('Latin', '-10'):
        ...
        self.multi_level_tester(
            code=code, expected=expected, output="Nice", max_level=7
        )
    ...
    def test_print_calc_arabic_directly(self):
        ...
        self.multi_level_tester(
            max_level=11, code=code, expected=expected, output=output, lang="ar"
        )
    ...
    def test_print_calc_arabic_directly_in_en(self):
        ...
        self.multi_level_tester(
            max_level=11, code=code, expected=expected, translate=False
        )
    ...
    def test_two_ifs_assign(self):
        ...
        self.multi_level_tester(
            max_level=7, code=code, expected=expected, translate=False
        )
