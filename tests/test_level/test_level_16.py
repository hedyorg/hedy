...
class TestsLevel16(HedyTester):
    ...
    def test_add_list_access_to_list(self):
        ...
        check_in_list = (
            lambda x: HedyTester.run_code(x) == "red"
        )  # check that 'red' was correctly appended
    ...
    def test_remove_list_access_from_list(self):
        ...
        check_removed_from_list = (
            lambda x: HedyTester.run_code(x) == "purple"
        )  # check that 'red' was removed
    ...
    def test_not_equal_with_diff_types_gives_error(self, left, right):
        ...
        self.single_level_tester(
            code, exception=exceptions.InvalidTypeCombinationException
        )
    ...
    def test_at_random_express(self, command):
        ...
        self.single_level_tester(
            code=code, exception=hedy.exceptions.InvalidAtCommandException
        )
    ...
    def test_at_random_express_sleep(self):
        ...
        skipped_mappings = [
            SkippedMapping(
                SourceRange(2, 1, 2, 24), hedy.exceptions.InvalidAtCommandException
            ),
        ]
