...
class TestsHelperFunctions(unittest.TestCase):
  ...
  def test_empty_command(self):
    ...
    self.assertEqual('<span class="command-highlighted">ask</span>', closest)
  ...
  def test_print_command_1(self):
    ...
    closest = hedy.closest_command(invalid_command, ['print', 'ask', 'echo'])
    self.assertEqual('<span class="command-highlighted">print</span>', closest)
  ...
  def test_echo_command_1(self):
    ...
    closest = hedy.closest_command(invalid_command, ['print', 'ask', 'echo'])
    self.assertEqual('<span class="command-highlighted">echo</span>', closest)
