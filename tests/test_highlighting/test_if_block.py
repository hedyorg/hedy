...
class HighlighterTestIfBlock(HighlightTester):
    ...
    def test_if_is1(self, level):
        self.assert_highlighted_chr(
            "if answer is yes", "KK TTTTTT KK TTT", level=level, lang="en"
        )
    ...
    def test_if_is2(self, level):
        self.assert_highlighted_chr(
            "if answer is 'yes'", "KK TTTTTT KK SSSSS", level=level, lang="en"
        )
    ...
    def test_if_is3(self, level):
        self.assert_highlighted_chr(
            "if answer is 4242", "KK TTTTTT KK NNNN", level=level, lang="en"
        )
    ...
    def test_if_eq1(self, level):
        self.assert_highlighted_chr(
            "if answer == yes", "KK TTTTTT KK TTT", level=level, lang="en"
        )
    ...
    def test_if_eq2(self, level):
        self.assert_highlighted_chr(
            "if answer == 'yes'", "KK TTTTTT KK SSSSS", level=level, lang="en"
        )
    ...
    def test_if_eq3(self, level):
        self.assert_highlighted_chr(
            "if answer == 4242", "KK TTTTTT KK NNNN", level=level, lang="en"
        )
    ...
    def test_if_in1(self, level):
        self.assert_highlighted_chr(
            "if answer in yes", "KK TTTTTT KK TTT", level=level, lang="en"
        )
    ...
    def test_if_in2(self, level):
        self.assert_highlighted_chr(
            "if answer in 'yes'", "KK TTTTTT KK SSSSS", level=level, lang="en"
        )
    ...
    def test_if_in3(self, level):
        self.assert_highlighted_chr(
            "if answer in 4242", "KK TTTTTT KK NNNN", level=level, lang="en"
        )
