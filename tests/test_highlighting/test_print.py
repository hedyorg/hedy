...
class HighlighterTestPrint(HighlightTester):
    ...
    def test_print1(self, level):
        self.assert_highlighted_chr(
            "print hello world!", "KKKKK TTTTTTTTTTTT", level=level, lang="en"
        )
    ...
    def test_print2(self, level):
        self.assert_highlighted_chr(
            "print 'hello world!'", "KKKKK SSSSSSSSSSSSSS", level=level, lang="en"
        )
    ...
    def test_print_random_alone(self, level):
        self.assert_highlighted_chr(
            "print animals at random", "KKKKK TTTTTTT KK KKKKKK", level=level, lang="en"
        )
