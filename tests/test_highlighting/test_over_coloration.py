...
class HighlighterTestOverCol(HighlightTester):
    ...
    def test_is1(self, level):
        self.assert_highlighted_chr(
            "ask is lost", "TTT KK TTTT", level=level, lang="en"
        )
    ...
    def test_is2(self, level):
        self.assert_highlighted_chr(
            "ask is 'lost'", "TTT KK SSSSSS", level=level, lang="en"
        )
    ...
    def test_Eq2(self, level):
        self.assert_highlighted_chr(
            "ask = 'lost'", "TTT K SSSSSS", level=level, lang="en"
        )
    ...
    def test_print1(self, level):
        self.assert_highlighted_chr(
            "print hello world! ask", "KKKKK TTTTTTTTTTTTTTTT", level=level, lang="en"
        )
    ...
    def test_at_prefix(self, level):
        self.assert_highlighted_chr(
            "print atoptis at random", "KKKKK TTTTTTT KK KKKKKK", level=level, lang="en"
        )
    ...
    def test_at_prefix_nl(self, level):
        self.assert_highlighted_chr(
            "print optis at random", "KKKKK TTTTT KK KKKKKK", level=level, lang="nl"
        )
    ...
    def test_to_prefix(self, level):
        self.assert_highlighted_chr(
            "add toanimal to animals", "KKK TTTTTTTT KK TTTTTTT", level=level, lang="en"
        )
