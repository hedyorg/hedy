...
class HighlighterTestTurtle(HighlightTester):
    ...
    def test_turn_right(self):
        self.assert_highlighted_chr(
            "turn right", "KKKK TTTTT", level="level1", lang="en"
        )
    ...
    def test_color_black(self, level):
        self.assert_highlighted_chr(
            "color black", "KKKKK TTTTT", level=level, lang="en"
        )
    ...
    def test_color_brown(self, level):
        self.assert_highlighted_chr(
            "color brown", "KKKKK TTTTT", level=level, lang="en"
        )
    ...
    def test_color_green(self, level):
        self.assert_highlighted_chr(
            "color green", "KKKKK TTTTT", level=level, lang="en"
        )
    ...
    def test_color_orange(self, level):
        self.assert_highlighted_chr(
            "color orange", "KKKKK TTTTTT", level=level, lang="en"
        )
    ...
    def test_color_purple(self, level):
        self.assert_highlighted_chr(
            "color purple", "KKKKK TTTTTT", level=level, lang="en"
        )
    ...
    def test_color_white(self, level):
        self.assert_highlighted_chr(
            "color white", "KKKKK TTTTT", level=level, lang="en"
        )
    ...
    def test_color_yellow(self, level):
        self.assert_highlighted_chr(
            "color yellow", "KKKKK TTTTTT", level=level, lang="en"
        )
