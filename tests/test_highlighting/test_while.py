...
class HighlighterTestWhile(HighlightTester):
    ...
    def test_while_str(self, level):
        self.assert_highlighted_chr(
            "while keys == 'lost'", "KKKKK TTTT KK SSSSSS", level=level, lang="en"
        )
    ...
    def test_while_number(self, level):
        self.assert_highlighted_chr(
            "while keys == 123", "KKKKK TTTT KK NNN", level=level, lang="en"
        )
    ...
    def test_while_var(self, level):
        self.assert_highlighted_chr(
            "while keys == var", "KKKKK TTTT KK TTT", level=level, lang="en"
        )
