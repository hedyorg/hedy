...
class HighlighterTestPrintArabic(HighlightTester):
    ...
    def test_print1(self, level):
        self.assert_highlighted_chr(
            "قول مرحبا أيها العالم!", "KKK TTTTTTTTTTTTTTTTTT", level=level, lang="ar"
        )
    ...
    def test_print2(self, level):
        self.assert_highlighted_chr(
            'قول "مرحبا أيها العالم"', "KKK SSSSSSSSSSSSSSSSSSS", level=level, lang="ar"
        )
    ...
    def test_is_number_equal_plus(self, level):
        self.assert_highlighted_chr(
            "sword = ١٢٣٤٦ + ٧٨٥٦٤", "TTTTT K NNNNN K NNNNN", level=level, lang="ar"
        )
    ...
    def test_is_number_equal_float_plus(self, level):
        self.assert_highlighted_chr(
            "sword = ١٢٣.٤٦ + ٧٩٤٩.٨", "TTTTT K NNNNNN K NNNNNN", level=level, lang="ar"
        )
