...
class HighlighterTestNumbers(HighlightTester):
    ...
    def test_nb_is_number(self, level):
        self.assert_highlighted_chr(
            "sword is 12346", "TTTTT KK NNNNN", level=level, lang="en"
        )
    ...
    def test_nb_is_number_equal(self, level):
        self.assert_highlighted_chr(
            "sword = 12346", "TTTTT K NNNNN", level=level, lang="en"
        )
    ...
    def test_nb_is_number_float(self, level):
        self.assert_highlighted_chr(
            "sword = 123.46", "TTTTT K NNNNNN", level=level, lang="en"
        )
    ...
    def test_nb_is_number_equal_float(self, level):
        self.assert_highlighted_chr(
            "sword is 123.46", "TTTTT KK NNNNNN", level=level, lang="en"
        )
    ...
    def test_nb_is_number_equal_float_unknow(self, level):
        self.assert_highlighted_chr(
            "sword = 123.46", "TTTTT K NNNTTT", level=level, lang="en"
        )
    ...
    def test_nb_is_number_equal_plus(self, level):
        self.assert_highlighted_chr(
            "sword = 12346 + 78564", "TTTTT K NNNNN K NNNNN", level=level, lang="en"
        )
    ...
    def test_nb_is_number_equal_float_plus(self, level):
        self.assert_highlighted_chr(
            "sword = 123.46 + 7949.8", "TTTTT K NNNNNN K NNNNNN", level=level, lang="en"
        )
