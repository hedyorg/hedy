...
class HighlighterTestList(HighlightTester):
    ...
    def test_list_string_smiley(self, level):
        self.assert_highlighted_chr(
            "variable is 🦔, 🦉, 🐿, 🦇", "TTTTTTTT KK TK TK TK T", level=level, lang="en"
        )
    ...
    def test_list_string_equ_smiley(self, level):
        self.assert_highlighted_chr(
            "variable = 🦔, 🦉, 🐿, 🦇", "TTTTTTTT K TK TK TK T", level=level, lang="en"
        )
    ...
    def test_list_add(self, level):
        self.assert_highlighted_chr(
            "add penguin to animals", "KKK TTTTTTT KK TTTTTTT", level=level, lang="en"
        )
