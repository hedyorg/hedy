...
def suite (username):
    return [
        ...
        ['get empty class', 'get', lambda state: '/for-teachers/class/' + state ['classes'] [0] ['id'], {}, {}, 200, getClass1],
        ...
        ['get renamed class', 'get', lambda state: '/for-teachers/class/' + state ['classes'] [0] ['id'], {}, {}, 200, getClass2],
        ...
        ['get class with a student', 'get', lambda state: '/for-teachers/class/' + state ['classes'] [0] ['id'], {}, {}, 200, getClass3],
