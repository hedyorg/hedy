...
1. Launch the the Hedy executable with sudo rights using $ sudo ./hedy.

2. This shall open a browser window if possible which shows the Hedy homepage.
   If no browser window was opened you can either ctrl+click one of the
   hyperlinks in the Command Prompt or go to http://localhost/ in your
   browser manually.
