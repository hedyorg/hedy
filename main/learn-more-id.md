page_title: Pelajari lebih lanjut — Hedy
---
...
<div class="w-full">
    ...
    <h2 class="py-2">Berlangganan ke buletin Hedy</h2>
    <div>
        <div class="mb-4">
        ...
        <div class="flex flex-row">
            <button type="submit" name="subscribe" id="mc-embedded-subscribe" class="green-btn mb-4">Berlangganan</button>
            <p class="ml-4 text-base">Fields marked with an <sup>*</sup> are required</p>
        </div>
    </div>
    <a href="https://us7.campaign-archive.com/home/?u=22a3ce4e09535f82f587a7118&id=57f3b3c090" target="_blank" title="View previous campaigns">Lihat kampanye-kampanye sebelumnya</a>
    </form>
</div>
<script type='text/javascript' src='//s3.amazonaws.com/downloads.mailchimp.com/js/mc-validate.js'></script><script type='text/javascript'>(function($) {window.fnames = new Array(); window.ftypes = new Array();fnames[0]='EMAIL';ftypes[0]='email';fnames[1]='FNAME';ftypes[1]='text';fnames[2]='LNAME';ftypes[2]='text';fnames[3]='COUNTRY';ftypes[3]='text';}(jQuery));var $mcj = jQuery.noConflict(true);</script>
<!--End mc_embed_signup-->

# Apakah kamu menyukai Hedy?
...
Ingin tahu lebih jauh lagi? Baca [publikasi risetnya](https://www.felienne.com/wp-content/uploads/2020/07/Hedy_paper_website_draft.pdf) tentang desain Hedy.

# Hedy dalam berita
Beberapa website dan koran telah menuliskan sesuatu tentang Hedy semenjak awal tahun 2020. Kami menyediakan daftarnya disini:
