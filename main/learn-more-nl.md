...
<div id="mc_embed_signup" class=" bg-white shadow-md rounded px-4 pb-4 mb-4">
...
<div class="mc-field-group">
    ...
    <button type="submit" name="subscribe" id="mc-embedded-subscribe" class="green-btn">Schrijf je in</button>
</div>
