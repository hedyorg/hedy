page_title: Untuk para guru — Hedy
---
...
- Siswa menggunakan nama variabel sebagai kata yang akan ditampilkan di perintah `print`; ini hanya diperbolehkan di level 3 keatas.
