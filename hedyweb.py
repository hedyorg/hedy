...
def render_code_editor_with_tabs(commands, max_level, level_number, version, quiz, quiz_questions, loaded_program, adventures, parsons, parsons_lines, customizations, hide_cheatsheet, hide_parsons, enforce_developers_mode, teacher_adventures, adventure_name):
    arguments_dict = {}
    ...
    arguments_dict['hide_parsons'] = hide_parsons
    ...
    arguments_dict['parsons_lines'] = parsons_lines
