// Dafny program hedy1.dfy compiled into C#
...
// Command Line Options: /spillTargetCode:2 .\hedyindafny\hedy1.dfy
// hedy1.dfy

datatype Com1 = Print(string) | Ask(string) | Echo(string) | Turn(D) | Forward(P) | Seq(Com1, Com1)

datatype D = Empty | Left | Right

datatype P = Empty | N(int)

datatype Maybe<T> = Nothing | Just(elem: T)

trait Env1 {
  var store: Maybe<string>
  ...
  decreases c, e
{
  match c {
    case {:split false} Print(x) =>
      e.Print(x);
    case {:split false} Ask(x) =>
      var answer := e.Ask(x);
      e.store := Just(answer);
    case {:split false} Echo(x) =>
      match e.store {
        case {:split false} Nothing =>
          e.Error(""echo without ask"");
        case {:split false} Just(s) =>
          e.Print(x + s);
      }
...
namespace _module {
  ...
  public interface _ICom1 {
    ...
    Dafny.ISequence<char> dtor_Ask_a0 { get; }
    Dafny.ISequence<char> dtor_Echo_a0 { get; }
    _ID dtor_Turn_a0 { get; }
    _IP dtor_Forward_a0 { get; }
    _ICom1 dtor_Seq_a0 { get; }
    _ICom1 dtor_Seq_a1 { get; }
    _ICom1 DowncastClone();
  }
  public abstract class Com1 : _ICom1 {
    public Com1() { }
    private static readonly _ICom1 theDefault = create_Print(Dafny.Sequence<char>.Empty);
    public static _ICom1 Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_ICom1> _TYPE = new Dafny.TypeDescriptor<_ICom1>(Com1.Default());
    public static Dafny.TypeDescriptor<_ICom1> _TypeDescriptor() {
      return _TYPE;
    }
    public static _ICom1 create_Print(Dafny.ISequence<char> _a0) {
      return new Com1_Print(_a0);
    }
    public static _ICom1 create_Ask(Dafny.ISequence<char> _a0) {
      return new Com1_Ask(_a0);
    }
    public static _ICom1 create_Echo(Dafny.ISequence<char> _a0) {
      return new Com1_Echo(_a0);
    }
    public static _ICom1 create_Turn(_ID _a0) {
      return new Com1_Turn(_a0);
    }
    public static _ICom1 create_Forward(_IP _a0) {
      return new Com1_Forward(_a0);
    }
    public static _ICom1 create_Seq(_ICom1 _a0, _ICom1 _a1) {
      return new Com1_Seq(_a0, _a1);
    }
    public bool is_Print { get { return this is Com1_Print; } }
    public bool is_Ask { get { return this is Com1_Ask; } }
    public bool is_Echo { get { return this is Com1_Echo; } }
    public bool is_Turn { get { return this is Com1_Turn; } }
    public bool is_Forward { get { return this is Com1_Forward; } }
    public bool is_Seq { get { return this is Com1_Seq; } }
    public Dafny.ISequence<char> dtor_Print_a0 {
      get {
        var d = this;
        return ((Com1_Print)d)._a0;
      }
    }
    public Dafny.ISequence<char> dtor_Ask_a0 {
      get {
        var d = this;
        return ((Com1_Ask)d)._a0;
      }
    }
    public Dafny.ISequence<char> dtor_Echo_a0 {
      get {
        var d = this;
        return ((Com1_Echo)d)._a0;
      }
    }
    public _ID dtor_Turn_a0 {
      get {
        var d = this;
        return ((Com1_Turn)d)._a0;
      }
    }
    public _IP dtor_Forward_a0 {
      get {
        var d = this;
        return ((Com1_Forward)d)._a0;
      }
    }
    public _ICom1 dtor_Seq_a0 {
      get {
        var d = this;
        return ((Com1_Seq)d)._a0;
      }
    }
    public _ICom1 dtor_Seq_a1 {
      get {
        var d = this;
        return ((Com1_Seq)d)._a1;
      }
    }
    public abstract _ICom1 DowncastClone();
  }
  public class Com1_Print : Com1 {
    public readonly Dafny.ISequence<char> _a0;
    public Com1_Print(Dafny.ISequence<char> _a0) {
      this._a0 = _a0;
    }
    public override _ICom1 DowncastClone() {
      if (this is _ICom1 dt) { return dt; }
      return new Com1_Print(_a0);
    }
    public override bool Equals(object other) {
      var oth = other as Com1_Print;
  ...
  public class Com1_Ask : Com1 {
    public readonly Dafny.ISequence<char> _a0;
    public Com1_Ask(Dafny.ISequence<char> _a0) {
      this._a0 = _a0;
    }
    public override _ICom1 DowncastClone() {
      if (this is _ICom1 dt) { return dt; }
  ...
  public class Com1_Echo : Com1 {
    public readonly Dafny.ISequence<char> _a0;
    public Com1_Echo(Dafny.ISequence<char> _a0) {
      this._a0 = _a0;
    }
    public override _ICom1 DowncastClone() {
      if (this is _ICom1 dt) { return dt; }
  ...
  public class Com1_Turn : Com1 {
    public readonly _ID _a0;
    public Com1_Turn(_ID _a0) {
      this._a0 = _a0;
    }
    public override _ICom1 DowncastClone() {
      if (this is _ICom1 dt) { return dt; }
  ...
  public class Com1_Forward : Com1 {
    public readonly _IP _a0;
    public Com1_Forward(_IP _a0) {
      this._a0 = _a0;
    }
    public override _ICom1 DowncastClone() {
      if (this is _ICom1 dt) { return dt; }
  ...
  public class Com1_Seq : Com1 {
    public readonly _ICom1 _a0;
    public readonly _ICom1 _a1;
    public Com1_Seq(_ICom1 _a0, _ICom1 _a1) {
      this._a0 = _a0;
      this._a1 = _a1;
    }
    public override _ICom1 DowncastClone() {
  ...
  public abstract class D : _ID {
    public D() { }
    private static readonly _ID theDefault = create_Empty();
    public static _ID Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_ID> _TYPE = new Dafny.TypeDescriptor<_ID>(D.Default());
    public static Dafny.TypeDescriptor<_ID> _TypeDescriptor() {
      return _TYPE;
    }
    public static _ID create_Empty() {
      return new D_Empty();
    }
    public static _ID create_Left() {
      return new D_Left();
    }
    public static _ID create_Right() {
      return new D_Right();
    }
    public bool is_Empty { get { return this is D_Empty; } }
    public bool is_Left { get { return this is D_Left; } }
    public bool is_Right { get { return this is D_Right; } }
    public static System.Collections.Generic.IEnumerable<_ID> AllSingletonConstructors {
      get {
        yield return D.create_Empty();
        yield return D.create_Left();
        yield return D.create_Right();
      }
    }
    public abstract _ID DowncastClone();
  }
  public class D_Empty : D {
    public D_Empty() {
    }
    public override _ID DowncastClone() {
      if (this is _ID dt) { return dt; }
      return new D_Empty();
    }
    public override bool Equals(object other) {
      var oth = other as D_Empty;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public interface _IP {
    bool is_Empty { get; }
    bool is_N { get; }
    BigInteger dtor_N_a0 { get; }
    _IP DowncastClone();
  }
  public abstract class P : _IP {
    public P() { }
    private static readonly _IP theDefault = create_Empty();
    public static _IP Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<_IP> _TYPE = new Dafny.TypeDescriptor<_IP>(P.Default());
    public static Dafny.TypeDescriptor<_IP> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IP create_Empty() {
      return new P_Empty();
    }
    public static _IP create_N(BigInteger _a0) {
      return new P_N(_a0);
    }
    public bool is_Empty { get { return this is P_Empty; } }
    public bool is_N { get { return this is P_N; } }
    ...
    public abstract _IP DowncastClone();
  }
  public class P_Empty : P {
    public P_Empty() {
    }
    public override _IP DowncastClone() {
      if (this is _IP dt) { return dt; }
      return new P_Empty();
    }
    public override bool Equals(object other) {
      var oth = other as P_Empty;
      return oth != null;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
  ...
  public abstract class Maybe<T> : _IMaybe<T> {
    ...
    public static _IMaybe<T> create_Just(T elem) {
      return new Maybe_Just<T>(elem);
    }
  ...
  public class Maybe_Just<T> : Maybe<T> {
    ...
    public Maybe_Just(T elem) {
      this.elem = elem;
    }
    public override _IMaybe<__T> DowncastClone<__T>(Func<T, __T> converter0) {
      if (this is _IMaybe<__T> dt) { return dt; }
      return new Maybe_Just<__T>(converter0(elem));
    }
    public override bool Equals(object other) {
      var oth = other as Maybe_Just<T>;
      return oth != null && object.Equals(this.elem, oth.elem);
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 1;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this.elem));
      return (int) hash;
    }
    public override string ToString() {
      string s = "Maybe.Just";
      s += "(";
      s += Dafny.Helpers.ToString(this.elem);
      s += ")";
      return s;
    }
  }
  ...
  public interface Env1 {
    _IMaybe<Dafny.ISequence<char>> store { get; set; }
  ...
  public class _Companion_Env1 {
  }

  public partial class __default {
    public static BigInteger bigstep__D__level1(_ID d) {
      _ID _source0 = d;
    ...
    public static BigInteger bigstep__P__level1(_IP p) {
      _IP _source1 = p;
      if (_source1.is_Empty) {
        return new BigInteger(50);
      } else {
        BigInteger _55___mcc_h0 = _source1.dtor_N_a0;
        BigInteger _56_n = _55___mcc_h0;
        return _56_n;
      }
    }
    public static void bigstep__level1(_ICom1 c, Env1 e)
    {
      _ICom1 _source2 = c;
      if (_source2.is_Print) {
        Dafny.ISequence<char> _57___mcc_h0 = _source2.dtor_Print_a0;
        Dafny.ISequence<char> _58_x = _57___mcc_h0;
        (e).Print(_58_x);
      } else if (_source2.is_Ask) {
        Dafny.ISequence<char> _59___mcc_h1 = _source2.dtor_Ask_a0;
        Dafny.ISequence<char> _60_x = _59___mcc_h1;
        Dafny.ISequence<char> _61_answer;
        Dafny.ISequence<char> _out0;
        _out0 = (e).Ask(_60_x);
        _61_answer = _out0;
        (e).store = Maybe<Dafny.ISequence<char>>.create_Just(_61_answer);
      } else if (_source2.is_Echo) {
        Dafny.ISequence<char> _62___mcc_h2 = _source2.dtor_Echo_a0;
        Dafny.ISequence<char> _63_x = _62___mcc_h2;
        _IMaybe<Dafny.ISequence<char>> _source3 = e.store;
        if (_source3.is_Nothing) {
          (e).Error(Dafny.Sequence<char>.FromString("echo without ask"));
        } else {
          Dafny.ISequence<char> _64___mcc_h7 = _source3.dtor_elem;
          Dafny.ISequence<char> _65_s = _64___mcc_h7;
          (e).Print(Dafny.Sequence<char>.Concat(_63_x, _65_s));
        }
      } else if (_source2.is_Turn) {
        _ID _66___mcc_h3 = _source2.dtor_Turn_a0;
        _ID _67_x = _66___mcc_h3;
        if ((e.turtle__exists) == (false)) {
          (e).Draw();
          (e).turtle__exists = true;
        }
        (e).Turn(__default.bigstep__D__level1(_67_x));
      } else if (_source2.is_Forward) {
        _IP _68___mcc_h4 = _source2.dtor_Forward_a0;
        _IP _69_x = _68___mcc_h4;
        if ((e.turtle__exists) == (false)) {
          (e).Draw();
          (e).turtle__exists = true;
        }
        (e).Forward(__default.bigstep__P__level1(_69_x));
      } else {
        _ICom1 _70___mcc_h5 = _source2.dtor_Seq_a0;
        _ICom1 _71___mcc_h6 = _source2.dtor_Seq_a1;
        _ICom1 _72_c2 = _71___mcc_h6;
        _ICom1 _73_c1 = _70___mcc_h5;
        {
          __default.bigstep__level1(_73_c1, e);
          __default.bigstep__level1(_72_c2, e);
        }
      }
    }
  }
