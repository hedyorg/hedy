// Dafny program hedy4.dfy compiled into C#
...
// Command Line Options: /spillTargetCode:2 .\hedyindafny\hedy4.dfy
// hedy4.dfy
...
namespace _module {
  ...
  public class _Companion_Env3 {
    ...
    public static Dafny.ISequence<char> SubstText(Env3 _this, Dafny.ISequence<char> plaintext)
    {
      ...
      for (BigInteger _193_i = BigInteger.Zero; _193_i < _hi0; _193_i++) {
        if (((plaintext).Select(_193_i)) == ('\'')) {
          _192_quotes = !(_192_quotes);
        }
        BigInteger _hi1 = new BigInteger((plaintext).Count);
        for (BigInteger _194_j = _193_i; _194_j < _hi1; _194_j++) {
          if (((_this.sigma).Contains(((plaintext).Subsequence(_193_i, _194_j)))) && (!(_192_quotes))) {
            _190_indexbegin = _193_i;
            _191_indexend = _194_j;
            _IM _source0 = Dafny.Map<Dafny.ISequence<char>, _IM>.Select(_this.sigma,(plaintext).Subsequence(_193_i, _194_j));
            if (_source0.is_N) {
              BigInteger _195___mcc_h0 = _source0.dtor_N_a0;
              BigInteger _196_x = _195___mcc_h0;
        ...
        if ((((_193_i) < (_190_indexbegin)) || ((_193_i) > (_191_indexend))) && (((plaintext).Select(_193_i)) != ('\''))) {
          valuestext = Dafny.Sequence<char>.Concat(valuestext, Dafny.Sequence<char>.FromElements((plaintext).Select(_193_i)));
        }
      }
      return valuestext;
    }
