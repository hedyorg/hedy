...
export const parser = LRParser.deserialize({
  ...
  nodeNames: "⚠ ask at random print forward turn color sleep is add from remove to_list clear Comment Program Command Assign Text ListAccess AssignList Comma Ask String Clear Print Turtle Forward Turn Color Sleep Add Remove ErrorInvalid",
  maxTerm: 67,
  nodeProps: [
    ["group", 27,"turtle"]
  ],
