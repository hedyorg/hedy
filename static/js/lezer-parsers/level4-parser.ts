...
export const parser = LRParser.deserialize({
  ...
  nodeNames: "⚠ ask at random print forward turn color sleep play is add from remove to_list clear Comment Program Command Assign Text ListAccess AssignList Comma Ask String Clear Print Play Turtle Forward Turn Color Sleep Add Remove ErrorInvalid",
  maxTerm: 70,
  nodeProps: [
    ["group", 29,"turtle"]
  ],
