...
export const TRANSLATIONS: Record<string, Record<MessageKey, string>> = {
  "ar": {
    ...
    "invite": "ادعو",
    "level_title": "مستوى",
    "multiple_keywords_warning": "أنت الآن تحاول استعمال الكلمة الرئيسة {orig_keyword}، لكن هذه الكلمة الرئيسة تحتمل أكثر من معنى. رجاء اختر المعنى الذي تقصده من هذه القائمة {keyword_list}، ونسخ الكلمة ثم لصقها إلى برنامجك، مع الأقواس المجعدة.",
