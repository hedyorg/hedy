...
export type MessageKey = 'CheckInternet' | 'Connection_error' | 'Empty_output' | 'Errors_found' | 'Execute_error' | 'Other_error' | 'Program_repair' | 'Program_too_long' | 'ServerError' | 'Transpile_error' | 'Transpile_success' | 'Transpile_warning' | 'Unsaved_Changes' | 'adventures_completed' | 'adventures_restored' | 'adventures_tried' | 'code' | 'common_mistakes' | 'copy_code_to_editor_description' | 'copy_link_to_share' | 'copy_to_editor' | 'customization_deleted' | 'dice' | 'directly_available' | 'disabled' | 'edit_code' | 'errors' | 'example_code' | 'fortune' | 'graph_title' | 'haunted' | 'invitations_sent' | 'invite' | 'level_title' | 'multiple_keywords_warning' | 'number_of_errors' | 'one_level_error' | 'program_size_too_long' | 'restaurant' | 'rock' | 'select_all' | 'selected' | 'songs' | 'successful_runs' | 'teacher_welcome' | 'turtle' | 'unsaved_class_changes' | 'workbook'
export const TRANSLATIONS: Record<string, Record<MessageKey, string>> = {
  "ar": {
    "CheckInternet": "ألق نظرة إذا كان اتصالك بالإنترنت يعمل بشكل صحيح.",
    ...
    "ServerError": "بإمكانك مساعدتنا بإرسال بريد إلكتروني يحتوي على المستوى والبرنامج الخاص بك، إلى hello@hedy.org. في الوقت الراهن، جرب شيئا مختلفا قليلا. شكرا!",
    ...
    "adventures_completed": "المغامرات المنهية: {number_of_adventures}",
    "adventures_restored": "أُرجعت المغامرات الأصلية.",
    "adventures_tried": "المغامرات المُحاولة",
    "code": "Code",
    "common_mistakes": "Common mistakes",
    "copy_code_to_editor_description": "Copy the following code to the main editor:",
    "copy_link_to_share": "انسخ الرابط لمشاركته",
    "copy_to_editor": "Copy code to editor",
    "customization_deleted": "تم حذف التخصيصات بنجاح.",
    "dice": "نرد 🎲",
    "directly_available": "افتتح مباشرة",
    "disabled": "مُوَّقَف عن العمل",
    "edit_code": "Edit code",
    "errors": "أخطاء",
    "example_code": "Coding example",
    "fortune": "🔮, ✨",
    "graph_title": "عدد الأخطاء حسب كل مستوى تم الانتهاء منه {level}",
    "haunted": "مسكون 🦇, 👻, 🎃",
    "invitations_sent": "أُرسلت كل الدعوات بنجاح!",
    "invite": "ادعو",
    "level_title": "مستوى",
    "multiple_keywords_warning": "تحاول الآن استعمال الكلمة الرئيسة {orig_keyword}، لكن هذه الكلمة الرئيسة تحتمل أكثر من معنى. رجاء اختر المعنى الذي تقصده من هذه القائمة {keyword_list}، وانسخ الكلمة ثم لصقها إلى برنامجك، مع الأقواس المجعدة",
    "number_of_errors": "عدد الأخطاء: {number_of_errors}",
    "one_level_error": "عليك أن تختار على الأقل مستوى واحدا.",
    "program_size_too_long": "Your program may not be longer than {amount_lines} lines!",
    "restaurant": "مطعم 🍣, 🍕, 🍔",
    "rock": "✂️, 📜, 🗻",
    "select_all": "اختر الجميع",
    "selected": "المُختار",
    "songs": "🎵,🎶",
    "successful_runs": "محاولات ناجحة:: {successful_runs}",
    "teacher_welcome": "مرحباً في هيدي! بكل فخر أنت الآن تمتلك حساباً كمعلم وذا يسمح لك بانشاء صفوف ودعوة تلاميذ.",
    "turtle": "سلحفاة 🐢",
    "unsaved_class_changes": "توجد تغييرات غير محفوظة، هل أنت متأكد أنك تريد مغادرة هذه الصفحة؟",
    "workbook": "Workbook"
  },
  "be": {
    "CheckInternet": "Праверце злучэнне з інтэрнэтам.",
    ...
    "copy_to_editor": "Copy code to editor",
    "customization_deleted": "Дапасаванні паспяхова выдалены.",
    "dice": "🎲",
  ...
  "ca": {
    ...
    "haunted": "🦇, 👻, 🎃",
    "invitations_sent": "S'han enviat totes les invitacions!",
    "invite": "Convida",
    "level_title": "Nivell",
    ...
    "teacher_welcome": "Benvinguda a Hedy! El teu compte s'ha actualitzat a compte de professor. Això et permetrà crear classes i convidar alumnes.",
    "turtle": "🐢",
  ...
  "fr": {
    ...
    "Execute_error": "Quelque chose s’est mal passé.",
    ...
    "ServerError": "Tu peux nous aider en nous envoyant un courriel avec le niveau et ton programme à hello@hedy.org. En attendant, essaye quelque chose d'un peu différent. Merci !",
  ...
  "id": {
    ...
    "Execute_error": "Terjadi kesalahan.",
    ...
    "ServerError": "Anda bisa membantu kami dengan mengirimkan email yang mencantumkan level dan program Anda ke hello@hedy.org. Sementara itu, cobalah sesuatu yang sedikit berbeda. Terima kasih!",
  ...
  "kab": {
    ...
    "ServerError": "Tzemreḍ ad aɣ-tɛawneḍ s tuzna n yimayl s uswir akked wahil-ik ɣer hello@hedy.org. Sya ar wass-nni, ɛreḍ kra yemgaraden. Tanemmirt!",
  ...
  "ko": {
    ...
    "Errors_found": "틀린것 같아요! 걱정 마세요, 프로그램은 여전히 실행됬어요",
  ...
  "nl": {
    ...
    "number_of_errors": "Number of errors: {number_of_errors}",
    "one_level_error": "You need to select at least one level.",
    "program_size_too_long": "Jouw programma mag niet langer zijn dan {amount_lines} regels!",
    "restaurant": "🍣, 🍕, 🍔",
    "rock": "✂️, 📜, 🗻",
  ...
  "so": {
    "CheckInternet": "Hubi in internetkaagu shaqaynayo.",
    "Connection_error": "Waanu haleeli waynay server-ka.",
    "Empty_output": "Afgarashadan way shaqaynaysaa balse waxba ma daabacayso. Raaci afgarashadaada amar daabacaad ama diin adeegso si aad wax usoo saarto.",
    "Errors_found": "Khalad baad samaysay! Ha walwalin, weli barnaamijka waan ka shaqaysiinaynaa",
    "Execute_error": "Waxbaa khaldamay.",
    "Other_error": "Alla! Khalad yar inaan samaynaa laga yaabaa.",
    "Program_repair": "Kanaa laga yabaa inuu yahay afgarashada saxda ah, ma hagaajin kartaa?",
    "Program_too_long": "Barnaamijkaaga waqti badan buu qaadanayaa inuu shaqeeyo.",
    "ServerError": "Waxaad nagu caawin kartaa inaad iimayl noogu soo dirto heerkaaga iyo barnaamijkaaga hello@hedy.org. Haddase, wax kale tijaabi. Mahadsanid!",
    "Transpile_error": "Kama shaqaysiin karno barnaamijkaaga.",
    "Transpile_success": "Shaqo wacan!\nCajiib!\nSi wacan!\nHeer sare!\nHawl weyn baad qabatay!",
    "Transpile_warning": "Digniin!",
    "Unsaved_Changes": "Waxaa jira barnamij aaadan kaydin. Ma rabtaa inaad ka baxdo adoon kaydin?",
    "adventures_completed": "Safarrada waa la dhammeeyay: {number_of_adventures}",
    "adventures_restored": "The default adventures have been restored.",
    "adventures_tried": "Adventures tried",
    "code": "Code",
    "common_mistakes": "Common mistakes",
  ...
  "zh_Hant": {
    "CheckInternet": "請檢查網際網路連線是否正常。",
    "Connection_error": "無法連上伺服器。",
    "Empty_output": "這段程式碼可以執行，但不會顯示任何內容。請在程式碼中加入 print 指令，或使用小海龜來顯示結果。",
    "Errors_found": "程式裡有一個小地方需要修改！別擔心，我們還是幫你執行了程式。",
    "Execute_error": "發生了一點問題。",
    "Other_error": "哎呀！也許是我們出了點小問題。",
    "Program_repair": "這段可能是正確的程式碼，你可以修好它嗎？",
    "Program_too_long": "你的程式執行太久了。",
    "ServerError": "你可以寄一封電子郵件到 hello@hedy.org，附上等級和你的程式，幫助我們找出問題。在那之前，也可以先試試稍微不同的寫法。謝謝！",
    "Transpile_error": "我們無法執行你的程式。",
    "Transpile_success": "做得好！\n太棒了！\n很好！\n真厲害！\n你做得很棒！",
    "Transpile_warning": "請注意！",
    "Unsaved_Changes": "你有尚未儲存的程式。確定要不儲存就離開嗎？",
    "adventures_completed": "已完成的冒險：{number_of_adventures}",
    "adventures_restored": "已還原預設冒險。",
    "adventures_tried": "嘗試過的冒險",
    "code": "Code",
    "common_mistakes": "Common mistakes",
    "copy_code_to_editor_description": "Copy the following code to the main editor:",
    "copy_link_to_share": "複製分享連結",
    "copy_to_editor": "Copy code to editor",
    "customization_deleted": "已成功刪除自訂設定。",
    "dice": "🎲",
    "directly_available": "直接開啟",
    "disabled": "已停用",
    "edit_code": "Edit code",
    "errors": "錯誤",
    "example_code": "Coding example",
    "fortune": "🔮, ✨",
    "graph_title": "第 {level} 級每個已完成冒險的錯誤數",
    "haunted": "🦇, 👻, 🎃",
    "invitations_sent": "所有邀請都已成功寄出！",
    "invite": "邀請",
    "level_title": "等級",
    "multiple_keywords_warning": "你正嘗試使用關鍵字 {orig_keyword}，但這個關鍵字可能有好幾種意思。請從以下清單選擇你想使用的項目，並將它連同大括號一起複製貼到程式碼中：{keyword_list}",
    "number_of_errors": "錯誤數量：{number_of_errors}",
    "one_level_error": "你必須至少選擇一個等級。",
    "program_size_too_long": "你的程式不能超過 {amount_lines} 行！",
    "restaurant": "🍣, 🍕, 🍔",
    "rock": "✂️, 📜, 🗻",
    "select_all": "全選",
    "selected": "已選取",
    "songs": "🎵,🎶",
    "successful_runs": "成功執行次數：{successful_runs}",
    "teacher_welcome": "歡迎來到 Hedy！你現在擁有教師帳號，可以建立班級並邀請學生。",
    "turtle": "🐢",
    "unsaved_class_changes": "還有尚未儲存的變更，確定要離開這個頁面嗎？",
    "workbook": "Workbook"
  }
};
