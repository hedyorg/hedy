...
export type MessageKey = 'CheckInternet' | 'Connection_error' | 'Empty_output' | 'Errors_found' | 'Execute_error' | 'Other_error' | 'Program_repair' | 'Program_too_long' | 'ServerError' | 'Transpile_error' | 'Transpile_success' | 'Transpile_warning' | 'Unsaved_Changes' | 'adventures_completed' | 'adventures_restored' | 'adventures_tried' | 'copy_link_to_share' | 'copy_to_editor' | 'customization_deleted' | 'dice' | 'directly_available' | 'disabled' | 'errors' | 'fortune' | 'graph_title' | 'haunted' | 'invitations_sent' | 'invite' | 'level_title' | 'multiple_keywords_warning' | 'number_of_errors' | 'one_level_error' | 'program_size_too_long' | 'restaurant' | 'rock' | 'select_all' | 'selected' | 'songs' | 'successful_runs' | 'teacher_welcome' | 'turtle' | 'unsaved_class_changes'
