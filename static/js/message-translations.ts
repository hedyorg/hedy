...
export const TRANSLATIONS: Record<string, Record<MessageKey, string>> = {
  ...
  "es": {
    ...
    "haunted": "🦇, 👻, 🎃",
    "invitations_sent": "¡Todas las invitaciones fueron enviadas correctamente!",
    "invite": "Invitar",
    "level_title": "Nivel",
  ...
  "et": {
    "CheckInternet": "Kontrolli kas su internetiühendus töötab.",
    ...
    "Errors_found": "Tegid vea! Ära muretse, me käivitasime programmi sellegipoolest",
    "Execute_error": "Midagi läks valesti.",
    ...
    "ServerError": "Saad meid aidata, saates e-kirja koos taseme ja oma programmiga aadressile hello@hedy.org. Seni aga proovi midagi veidi teistsugust. Aitäh!",
  ...
  "sv": {
    "CheckInternet": "Kontrollera om din internetanslutning fungerar.",
