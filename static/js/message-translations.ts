...
export const TRANSLATIONS: Record<string, Record<MessageKey, string>> = {
  "ar": {
    ...
    "one_level_error": "You have to select at least one level",
    "restaurant": "🍣, 🍕, 🍔",
    "rock": "✂️, 📜, 🗻",
