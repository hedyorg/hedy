...
export type MessageKey = 'CheckInternet' | 'Connection_error' | 'Empty_output' | 'Errors_found' | 'Execute_error' | 'Other_error' | 'Program_repair' | 'Program_too_long' | 'ServerError' | 'Transpile_error' | 'Transpile_success' | 'Transpile_warning' | 'Unsaved_Changes' | 'adventures_completed' | 'adventures_restored' | 'adventures_tried' | 'copy_link_to_share' | 'customization_deleted' | 'dice' | 'directly_available' | 'disabled' | 'errors' | 'fortune' | 'graph_title' | 'haunted' | 'level_title' | 'multiple_keywords_warning' | 'number_of_errors' | 'restaurant' | 'rock' | 'selected' | 'songs' | 'successful_runs' | 'teacher_welcome' | 'turtle' | 'unsaved_class_changes'
