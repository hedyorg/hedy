...
export type MessageKey = 'CheckInternet' | 'Connection_error' | 'Empty_output' | 'Execute_error' | 'Other_error' | 'Program_repair' | 'Program_too_long' | 'ServerError' | 'Transpile_error' | 'Transpile_success' | 'Transpile_warning' | 'Unsaved_Changes' | 'copy_link_to_share' | 'dice' | 'fortune' | 'haunted' | 'level_title' | 'restaurant' | 'rock' | 'songs' | 'teacher_welcome' | 'turtle' | 'unsaved_class_changes'
