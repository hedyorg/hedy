...
export const TRANSLATIONS: Record<string, Record<MessageKey, string>> = {
  ...
  "kab": {
    ...
    "ServerError": "Turiḍ ahil iɣef ur nebni ara. Ma tebɣiḍ ad d-tɛawneḍ, azen-aɣ-d imayl s uswir akked wahil-ik ɣer hello@hedy.org. Sya ar wass-nni, εreḍ kra yemgaraden, tesneqdeḍ i tikkelt niḍen imedyaten. Tanemmirt!",
  ...
  "sr": {
    ...
    "Execute_error": "Нешто је пошло наопако приликом покретања програма.",
    ...
    "ServerError": "Написали сте програм који нисмо очекивали. Ако желите да помогнете, пошаљите нам имејл са нивоом и вашим програмом на hello@hedy.org. У међувремену, пробајте нешто мало другачије и поново погледајте примере. Хвала!",
