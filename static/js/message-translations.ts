...
export const TRANSLATIONS: Record<string, Record<MessageKey, string>> = {
  ...
  "fr": {
    ...
    "Errors_found": "Vous avez fait une erreur ! Ne t'inquiètes pas, Hedy essaie de trouver les erreurs",
  ...
  "ko": {
    "CheckInternet": "인터넷 연결이 제대로 작동하는지 확인해 보십시오.",
    ...
    "ServerError": "당신은 저희가 예상하지 못했던 프로그램을 작성했습니다. 만약 도움을 주고 싶다면, 우리에게 수준과 hello@hedy.org 에 있는 당신의 프로그램과 함께 이메일을 보내주세요. 그 동안, 조금 다른 것을 시도해보고 사례를 다시 살펴보세요. 감사합니다!",
    ...
    "rock": "✂️, 📜, 🗻",
    "songs": "🎵,🎶",
    "teacher_welcome": "Hedy에 오신 것을 환영합니다! 여러분은 이제 수업을 만들고 학생들을 초대할 수 있는 선생님 계정의 자랑스러운 소유자가 되었습니다.",
    "turtle": "🐢",
    "unsaved_class_changes": "저장하지 않은 변경사항이 있습니다. 이 페이지를 떠나시겠습니까?"
  },
  "nl": {
