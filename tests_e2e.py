...
suite = [
    ...
    ['valid login before verifying', 'post', '/auth/login', {}, {'username': username, 'password': 'foobar'}, 403],
    ...
    invalidMap ('change password', 'post', '/auth/changePassword', ['', [], {}, {'foo': 'bar'}, {'oldPassword': 1}, {'oldPassword': 'foobar'}, {'oldPassword': 'foobar', 'newPassword': 1}, {'oldPassword': 'foobar', 'newPassword': 'short'}]),
