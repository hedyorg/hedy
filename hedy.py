...
local_keywords_enabled = False or 'pytest' in sys.argv[0] or environ['GITHUB_ACTIONS'] == 'true' # If this is True, only the keywords in the specified language can be used for now
