...
def load_adventures_per_level(level):
    ...
    for short_name, adventure in adventures.items():
        ...
        current_adventure = {
            ...
            'text': adventure['levels'][level].get('story_text').format(**KEYWORDS.get(g.keyword_lang, KEYWORDS.get("en"))) if adventure['levels'][level].get('story_text') else '',
            'example_code': adventure['levels'][level].get('example_code').format(**KEYWORDS.get(g.keyword_lang, KEYWORDS.get("en"))) if adventure['levels'][level].get('example_code') else '',
            'start_code': adventure['levels'][level].get('start_code').format(**KEYWORDS.get(g.keyword_lang, KEYWORDS.get("en"))) if adventure['levels'][level].get('start_code') else '',
        ...
        for i in range(2, 10):
            ...
            if adventure['levels'][level].get('story_text_' + str(i)):
                extra_story['text'] = adventure['levels'][level].get('story_text_' + str(i)).format(**KEYWORDS.get(g.keyword_lang, KEYWORDS.get("en")))
                if adventure['levels'][level].get('example_code_' + str(i)):
                    extra_story['example_code'] = adventure['levels'][level].get('example_code_' + str(i)).format(**KEYWORDS.get(g.keyword_lang, KEYWORDS.get("en")))
