...
def routes (app, database):
    ...
    def get_class_info(user, class_id):
        ...
        return render_template ('customize-class.html', auth=TRANSLATIONS.get_translations (g.lang, 'Auth'), menu=render_main_menu('for-teachers'), class_info={'name': Class ['name']}, adventures=adventures, preferences=preferences, current_page='for-teachers')
